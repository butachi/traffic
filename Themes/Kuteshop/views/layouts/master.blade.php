...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ Theme::url('vendor/bootstrap/css/bootstrap.min.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ Theme::url('vendor/font-awesome/css/font-awesome.min.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ Theme::url('vendor/select2/css/select2.min.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ Theme::url('vendor/owl.carousel/owl.carousel.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ Theme::url('vendor/jquery-ui/jquery-ui.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ Theme::url('css/animate.css') }}" />
    <link rel="stylesheet" type="text/css" href="{{ Theme::url('css/reset.css') }}" />
    ...
    <link rel="stylesheet" type="text/css" href="{{ Theme::url('css/option6.css') }}" />
    <title>Kute shop Option 6</title>
</head>
<body class="option6">
<!-- HEADER -->
...
<div class="container main-header">
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-3 logo">
            <a href="index-2.html"><img alt="Kute Shop" src="{{ Theme::url('data') }}/option6/logo.png" /></a>
        </div>
                            ...
                            <ul>
                                <li class="product-info">
                                    <div class="p-left">
                                        ...
                                        <a href="#">
                                            <img class="img-responsive" src="{{ Theme::url('data') }}/product-100x122.jpg" alt="p10">
                                        </a>
                                    </div>
                                    <div class="p-right">
                                ...
                                <li class="product-info">
                                    <div class="p-left">
                                        <a href="#" class="remove_link"></a>
                                        <a href="#">
                                            <img class="img-responsive" src="{{ Theme::url('data') }}/product-s5-100x122.jpg" alt="p10">
                                        </a>
                                    </div>
                                    <div class="p-right">
                                        <p class="p-name">Donec Ac Tempus</p>
    ...
    <div class="box-vertical-megamenus">
        ...
        <div class="vertical-menu-content is-home">
            <ul class="vertical-menu-list">
                <li><a href="#"><img class="icon-menu" alt="Funky roots" src="{{ Theme::url('data') }}/12.png">Electronics</a></li>
                <li>
                    <a class="parent" href="#"><img class="icon-menu" alt="Funky roots" src="{{ Theme::url('data') }}/13.png">Sports &amp; Outdoors</a>
                    <div class="vertical-dropdown-menu">
                        <div class="vertical-groups col-sm-12">
                            ...
                            <div class="mega-custom-html col-sm-12">
                                <a href="#"><img src="{{ Theme::url('data') }}/banner-megamenu.jpg" alt="Banner"></a>
                            </div>
                        </div>
                    </div>
                </li>
                <li><a href="#"><img class="icon-menu" alt="Funky roots" src="{{ Theme::url('data') }}/14.png">Smartphone &amp; Tablets</a></li>
                <li><a href="#"><img class="icon-menu" alt="Funky roots" src="{{ Theme::url('data') }}/15.png">Health &amp; Beauty Bags</a></li>
                <li>
                    <a class="parent" href="#">
                        <img class="icon-menu" alt="Funky roots" src="{{ Theme::url('data') }}/16.png">Shoes &amp; Accessories</a>
                    <div class="vertical-dropdown-menu">
                        <div class="vertical-groups col-sm-12">
                                ...
                                <div class="row mega-products">
                                    <div class="col-sm-3 mega-product">
                                        <div class="product-avatar">
                                            <a href="#"><img src="{{ Theme::url('data') }}/p10.jpg" alt="product1"></a>
                                        </div>
                                    ...
                                    <div class="col-sm-3 mega-product">
                                        <div class="product-avatar">
                                            <a href="#"><img src="{{ Theme::url('data') }}/p11.jpg" alt="product1"></a>
                                        </div>
                                        <div class="product-name">
                                            <a href="#">Fashion hand bag</a>
                                        </div>
                                    ...
                                    <div class="col-sm-3 mega-product">
                                        <div class="product-avatar">
                                            <a href="#"><img src="{{ Theme::url('data') }}/p12.jpg" alt="product1"></a>
                                        </div>
                                        <div class="product-name">
                                            <a href="#">Fashion hand bag</a>
                                        </div>
                                    ...
                                    <div class="col-sm-3 mega-product">
                                        <div class="product-avatar">
                                            <a href="#"><img src="{{ Theme::url('data') }}/p13.jpg" alt="product1"></a>
                                        </div>
                                        <div class="product-name">
                                            <a href="#">Fashion hand bag</a>
                                        </div>
                ...
                <li><a href="#"><img class="icon-menu" alt="Funky roots" src="{{ Theme::url('data') }}/17.png">Toys &amp; Hobbies</a></li>
                <li><a href="#"><img class="icon-menu" alt="Funky roots" src="{{ Theme::url('data') }}/18.png">Computers &amp; Networking</a></li>
                <li><a href="#"><img class="icon-menu" alt="Funky roots" src="{{ Theme::url('data') }}/19.png">Laptops &amp; Accessories</a></li>
                <li><a href="#"><img class="icon-menu" alt="Funky roots" src="{{ Theme::url('data') }}/20.png">Jewelry &amp; Watches</a></li>
                <li><a href="#"><img class="icon-menu" alt="Funky roots" src="{{ Theme::url('data') }}/21.png">Flashlights &amp; Lamps</a></li>
                <li>
                    <a href="#">
                        <img class="icon-menu" alt="Funky roots" src="{{ Theme::url('data') }}/21.png">
                        Cameras &amp; Photo
                    </a>
                </li>
                <li class="cat-link-orther">
                    <a href="#">
                        <img class="icon-menu" alt="Funky roots" src="{{ Theme::url('data') }}/22.png">
                        Television
                    </a>
                </li>
                <li class="cat-link-orther">
                    <a href="#">
                        <img class="icon-menu" alt="Funky roots" src="{{ Theme::url('data') }}/12.png">Computers &amp; Networking
                    </a>
                </li>
                <li class="cat-link-orther">
                    <a href="#">
                        <img class="icon-menu" alt="Funky roots" src="{{ Theme::url('data') }}/14.png">
                        Toys &amp; Hobbies
                    </a>
                </li>
                <li class="cat-link-orther">
                    <a href="#"><img class="icon-menu" alt="Funky roots" src="{{ Theme::url('data') }}/17.png">Jewelry &amp; Watches</a></li>
            </ul>
        ...
        <ul class="dropdown-menu mega_dropdown" role="menu" style="width: 830px;">
            <li class="block-container col-sm-3">
                <ul class="block">
                    <li class="img_container">
                        <a href="#">
                            <img class="img-responsive" src="{{ Theme::url('data') }}/men.png" alt="sport">
                        </a>
                    </li>
            ...
            <li class="block-container col-sm-3">
                <ul class="block">
                    <li class="img_container">
                        <a href="#">
                            <img class="img-responsive" src="{{ Theme::url('data') }}/women.png" alt="sport">
                        </a>
                    </li>
                    <li class="link_container group_header">
                        <a href="#">WOMEN'S</a>
            ...
            <li class="block-container col-sm-3">
                <ul class="block">
                    <li class="img_container">
                        <a href="#">
                            <img class="img-responsive" src="{{ Theme::url('data') }}/kid.png" alt="sport">
                        </a>
                    </li>
                    <li class="link_container group_header">
                        <a href="#">Kids</a>
            ...
            <li class="block-container col-sm-3">
                <ul class="block">
                    <li class="img_container">
                        <a href="#">
                            <img class="img-responsive" src="{{ Theme::url('data') }}/trending.png" alt="sport">
                        </a>
                    </li>
                    <li class="link_container group_header">
                        <a href="#">TRENDING</a>
    ...
    <li class="dropdown">
        ...
        <ul class="mega_dropdown dropdown-menu" style="width: 830px;">
            ...
            <li class="block-container col-sm-3">
                <ul class="block">
                    <li class="img_container">
                        <img src="{{ Theme::url('data') }}/banner-topmenu.jpg" alt="Banner">
                    </li>
                </ul>
            </li>
        ...
        <div class="row">
            <div class="col-sm-8" style="padding-right: 0px;">
                <div class="homeslider">
                    <ul id="contenhomeslider-customPage">
                        <li><img alt="Funky roots" src="{{ Theme::url('data') }}/option6/slide1.jpg" title="Funky roots" /></li>
                        <li><img alt="Funky roots" src="{{ Theme::url('data') }}/option6/slide1.jpg" title="Funky roots" /></li>
                        <li><img  alt="Funky roots" src="{{ Theme::url('data') }}/option6/slide1.jpg" title="Funky roots" /></li>
                    </ul>
            ...
            <div class="col-sm-2 group-banner-slider" style="padding-left: 2px;">
                <div class="item banner-opacity">
                    <a href="#"><img src="{{ Theme::url('data') }}/option6/banner9.jpg" alt="Banner"></a>
                </div>
                <div class="item banner-opacity">
                    <a href="#"><img src="{{ Theme::url('data') }}/option6/banner10.jpg" alt="Banner"></a>
                </div>
                <div class="banner-opacity">
                    <a href="#"><img src="{{ Theme::url('data') }}/option6/banner11.jpg" alt="Banner"></a>
                </div>
            </div>
            <div class="col-sm-2 group-banner-slider" style="padding-left: 2px; margin-left:-15px; padding-right: 0;">
                <div class=" item policy">
                    ...
                    <ul>
                        <li><a href="#">
                                <img class="icon1" src="{{ Theme::url('data') }}/option6/safe1.png" alt="Icon">
                                <img class="icon2" src="{{ Theme::url('data') }}/option6/safe2.png" alt="Icon">
                                Safe Payment
                            </a></li>
                        <li><a href="#">
                                <img class="icon1" src="{{ Theme::url('data') }}/option6/icon2.png" alt="Icon">
                                <img class="icon2" src="{{ Theme::url('data') }}/option6/icon2-1.png" alt="Icon">
                                Worldwide Delivery</a></li>
                        <li><a href="#">
                                <img class="icon1" src="{{ Theme::url('data') }}/option6/icon3.png" alt="Icon">
                                <img class="icon2" src="{{ Theme::url('data') }}/option6/icon3-1.png" alt="Icon">
                                Change Pay</a></li>
                        <li><a href="#">
                                <img class="icon1" src="{{ Theme::url('data') }}/option6/icon4.png" alt="Icon">
                                <img class="icon2" src="{{ Theme::url('data') }}/option6/icon4-1.png" alt="Icon">
                                Customer Service</a></li>
                        <li><a href="#">
                                <img class="icon1" src="{{ Theme::url('data') }}/option6/icon5.png" alt="Icon">
                                <img class="icon2" src="{{ Theme::url('data') }}/option6/icon5-1.png" alt="Icon">
                                Sales Of Prestige</a></li>
                    </ul>
                </div>
                <div class="item banner-opacity">
                    <a href="#"><img src="{{ Theme::url('data') }}/option6/banner12.jpg" alt="Banner"></a>
                </div>
                <div class="banner-opacity">
                    <a href="#"><img src="{{ Theme::url('data') }}/option6/banner13.jpg" alt="Banner"></a>
                </div>
            </div>
        ...
        <div class="row">
                ...
                <div class="block-popular-cat">
                    ...
                    <div class="block-popular-inner">
                        <div class="image banner-boder-zoom2">
                            <a href="#"><img src="{{ Theme::url('data') }}/option6/popular1.jpg" alt="popular"></a>
                        </div>
            ...
            <div class="col-sm-4">
                <div class="block-popular-cat">
                    ...
                    <div class="block-popular-inner">
                        <div class="image banner-boder-zoom2">
                            <a href="#"><img src="{{ Theme::url('data') }}/option6/popular2.jpg" alt="popular"></a>
                        </div>
                        <div class="sub-categories">
                            <ul>
            ...
            <div class="col-sm-4">
                <div class="block-popular-cat">
                    ...
                    <div class="block-popular-inner">
                        <div class="image banner-boder-zoom2">
                            <a href="#"><img src="{{ Theme::url('data') }}/option6/popular3.jpg" alt="popular"></a>
                        </div>
                        <div class="sub-categories">
                            <ul>
        ...
        <div class="row banner-bottom">
            <div class="col-sm-6 item-left">
                <div class="banner-boder-zoom2">
                    <a href="#"><img alt="ads" class="img-responsive" src="{{ Theme::url('data') }}/option6/banner1.jpg" /></a>
                </div>
            </div>
            <div class="col-sm-6 item-right">
                <div class="banner-boder-zoom">
                    <a href="#"><img alt="ads" class="img-responsive" src="{{ Theme::url('data') }}/option6/banner2.jpg" /></a>
                </div>
            </div>
        </div>
        <!-- end banner bottom -->
...
<nav class="navbar nav-menu show-brand">
    <div class="container">
        ...
        <div class="navbar-brand"><a href="#"><img alt="fashion" src="{{ Theme::url('data') }}/icon-fashion.png" />fashion</a></div>
...
<div class="tab-panel active" id="tab-4">
    <div class="box-left">
        <div class="banner-img">
            <a href="#"><img src="{{ Theme::url('data') }}/option6/banner3.jpg" alt="Banner Product"></a>
        </div>
    </div>
    <div class="box-right">
        <ul class="product-list row">
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#"><img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/p48.jpg" /></a>
            ...
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#"><img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/p49.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
            ...
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#"><img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/p50.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
            ...
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#"><img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/p51.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
            ...
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#"><img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/p52.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
            ...
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#"><img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/p53.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
    ...
    <div class="box-right">
        <ul class="product-list row">
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#">
                        <img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/p53.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
            ...
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#">
                        <img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/p52.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
            ...
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#">
                        <img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/p51.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
            ...
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#">
                        <img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/p50.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
            ...
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#">
                        <img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/p49.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
            ...
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#">
                        <img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/p48.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
...
<nav class="navbar nav-menu show-brand">
    <div class="container">
        <!-- Brand and toggle get grouped for better mobile display -->
        <div class="navbar-brand"><a href="#"><img alt="fashion" src="{{ Theme::url('data') }}/icon-sports.png" />SPORTS</a></div>
        <span class="toggle-menu"></span>
        <!-- Collect the nav links, forms, and other content for toggling -->
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
...
<div class="tab-panel active" id="tab-6">
    <div class="box-left">
        <div class="banner-img">
            <a href="#"><img src="{{ Theme::url('data') }}/option6/banner4.jpg" alt="Banner Product"></a>
        </div>
    </div>
    <div class="box-right">
        <ul class="product-list row">
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#">
                        <img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/p55.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
            ...
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#">
                        <img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/p56.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
            ...
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#">
                        <img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/p57.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
            ...
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#">
                        <img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/p58.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
            ...
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#">
                        <img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/p59.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
            ...
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#">
                        <img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/p60.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
...
<nav class="navbar nav-menu show-brand">
    <div class="container">
        <!-- Brand and toggle get grouped for better mobile display -->
        <div class="navbar-brand"><a href="#"><img alt="fashion" src="{{ Theme::url('data') }}/icon-electronic.png" />ELECTRONICS</a></div>
        <span class="toggle-menu"></span>
        <!-- Collect the nav links, forms, and other content for toggling -->
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
...
<div class="tab-panel active" id="tab-8">
    <div class="box-left">
        <div class="banner-img">
            <a href="#"><img src="{{ Theme::url('data') }}/option6/banner5.jpg" alt="Banner Product"></a>
        </div>
    </div>
    <div class="box-right">
        <ul class="product-list row">
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#">
                        <img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/p61.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
            ...
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#">
                        <img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/p62.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
            ...
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#">
                        <img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/p63.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
            ...
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#">
                        <img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/p64.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
            ...
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#">
                        <img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/p65.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
            ...
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#">
                        <img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/p66.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
...
<nav class="navbar nav-menu show-brand">
    <div class="container">
        <!-- Brand and toggle get grouped for better mobile display -->
        <div class="navbar-brand"><a href="#"><img alt="fashion" src="{{ Theme::url('data') }}/icon-digital.png" />DIGITAL</a></div>
        <span class="toggle-menu"></span>
        <!-- Collect the nav links, forms, and other content for toggling -->
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
...
<div class="tab-panel active" id="tab-10">
    <div class="box-left">
        <div class="banner-img">
            <a href="#"><img src="{{ Theme::url('data') }}/option6/banner6.jpg" alt="Banner Product"></a>
        </div>
    </div>
    <div class="box-right">
        <ul class="product-list row">
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#">
                        <img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/option6/p5.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
            ...
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#">
                        <img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/option6/p70.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
            ...
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#">
                        <img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/option6/p71.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
            ...
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#">
                        <img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/option6/p10.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
            ...
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#">
                        <img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/option6/p6.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
            ...
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#">
                        <img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/option6/p11.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
    ...
    <div class="box-right">
        <ul class="product-list row">
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#">
                        <img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/p73.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
            ...
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#">
                        <img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/p72.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
            ...
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#">
                        <img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/p71.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
            ...
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#">
                        <img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/p70.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
            ...
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#">
                        <img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/p69.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
            ...
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#">
                        <img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/p68.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
...
<nav class="navbar nav-menu show-brand">
    <div class="container">
        <!-- Brand and toggle get grouped for better mobile display -->
        <div class="navbar-brand"><a href="#"><img alt="fashion" src="{{ Theme::url('data') }}/icon-furniture.png" />furniture</a></div>
        <span class="toggle-menu"></span>
        <!-- Collect the nav links, forms, and other content for toggling -->
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
...
<div class="tab-panel active" id="tab-12">
    <div class="box-left">
        <div class="banner-img">
            <a href="#"><img src="{{ Theme::url('data') }}/option6/banner7.jpg" alt="Banner Product"></a>
        </div>
    </div>
    <div class="box-right">
        <ul class="product-list row">
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#">
                        <img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/option6/p8.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
            ...
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#">
                        <img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/option6/p9.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
            ...
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#">
                        <img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/option6/p7.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
            ...
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#">
                        <img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/option6/p14.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
            ...
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#">
                        <img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/option6/p12.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
            ...
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#">
                        <img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/option6/p13.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
...
<div class="tab-panel" id="tab-13">
    <div class="box-left">
        <div class="banner-img">
            <a href="#"><img src="{{ Theme::url('data') }}/banner-product3.jpg" alt="Banner Product"></a>
        </div>
    </div>
    <div class="box-right">
        <ul class="product-list row">
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#">
                        <img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/p78.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
            ...
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#">
                        <img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/p77.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
            ...
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#">
                        <img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/p76.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
            ...
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#">
                        <img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/p75.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
            ...
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#">
                        <img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/p74.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
...
<nav class="navbar nav-menu show-brand">
    <div class="container">
        <!-- Brand and toggle get grouped for better mobile display -->
        <div class="navbar-brand"><a href="#"><img alt="fashion" src="{{ Theme::url('data') }}/icon-jewelry.png" />jewelry</a></div>
        <span class="toggle-menu"></span>
        <!-- Collect the nav links, forms, and other content for toggling -->
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
...
<div class="tab-panel active" id="tab-12">
    <div class="box-left">
        <div class="banner-img">
            <a href="#"><img src="{{ Theme::url('data') }}/option6/banner8.jpg" alt="Banner Product"></a>
        </div>
    </div>
    <div class="box-right">
        <ul class="product-list row">
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#">
                        <img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/p81.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
            ...
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#">
                        <img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/p82.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
            ...
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#">
                        <img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/p83.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
            ...
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#">
                        <img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/p84.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
            ...
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#">
                        <img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/p85.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
            ...
            <li class="col-sm-4">
                ...
                <div class="left-block">
                    <a href="#">
                        <img class="img-responsive" alt="product" src="{{ Theme::url('data') }}/p86.jpg" /></a>
                    <div class="quick-view">
                        <a title="Add to my wishlist" class="heart" href="#"></a>
                        <a title="Add to compare" class="compare" href="#"></a>
                        <a title="Quick view" class="search" href="#"></a>
...
<div id="content-wrap">
    <div class="container">
        <div class="band-logo owl-carousel"  data-dots="false" data-loop="true" data-nav = "true" data-margin = "1.2" data-autoplay="true" data-responsive='{"0":{"items":3},"600":{"items":5},"1000":{"items":8}}'>
            <a href="#"><img src="{{ Theme::url('data') }}/option6/band-logo.png" alt="Band logo"></a>
            <a href="#"><img src="{{ Theme::url('data') }}/option6/band-logo.png" alt="Band logo"></a>
            <a href="#"><img src="{{ Theme::url('data') }}/option6/band-logo.png" alt="Band logo"></a>
            <a href="#"><img src="{{ Theme::url('data') }}/option6/band-logo.png" alt="Band logo"></a>
            <a href="#"><img src="{{ Theme::url('data') }}/option6/band-logo.png" alt="Band logo"></a>
                ...
                <ul class="owl-carousel" data-dots="false" data-loop="true" data-nav = "true" data-margin = "30" data-autoplayTimeout="1000" data-autoplayHoverPause = "true" data-responsive='{"0":{"items":1},"600":{"items":3},"1000":{"items":4}}'>
                    <li>
                        <div class="post-thumb image-hover2">
                            <a href="#"><img src="{{ Theme::url('data') }}/option6/blog1.jpg" alt="Blog"></a>
                        </div>
                        <div class="post-desc">
                            <h5 class="post-title">
                    ...
                    <li>
                        <div class="post-thumb image-hover2">
                            <a href="#"><img src="{{ Theme::url('data') }}/option6/blog2.jpg" alt="Blog"></a>
                        </div>
                        <div class="post-desc">
                            <h5 class="post-title">
                                <a href="#">Share the love with KuteShop</a>
                    ...
                    <li>
                        <div class="post-thumb image-hover2">
                            <a href="#"><img src="{{ Theme::url('data') }}/option6/blog3.jpg" alt="Blog"></a>
                        </div>
                        <div class="post-desc">
                            <h5 class="post-title">
                    ...
                    <li>
                        <div class="post-thumb image-hover2">
                            <a href="#"><img src="{{ Theme::url('data') }}/option6/blog4.jpg" alt="Blog"></a>
                        </div>
                        <div class="post-desc">
                            <h5 class="post-title">
                    ...
                    <div class="service-wapper">
                        <div class="row">
                            <div class="col-sm-6 image">
                                <div class="icon">
                                    <img src="{{ Theme::url('data') }}/icon-s1.png" alt="service">
                                </div>
                ...
                <li class="col-xs-12 col-sm-6 col-md-4 services2-item">
                    <div class="service-wapper">
                        <div class="row">
                            <div class="col-sm-6 image">
                                <div class="icon">
                                    <img src="{{ Theme::url('data') }}/icon-s2.png" alt="service">
                                </div>
                ...
                <li class="col-xs-12 col-sm-6 col-md-4 services2-item">
                    <div class="service-wapper">
                        <div class="row">
                            <div class="col-sm-6 image">
                                <div class="icon">
                                    <img src="{{ Theme::url('data') }}/icon-s3.png" alt="service">
                                </div>
                ...
                <li class="col-xs-12 col-sm-6 col-md-4 services2-item">
                    <div class="service-wapper">
                        <div class="row">
                            <div class="col-sm-6 image">
                                <div class="icon">
                                    <img src="{{ Theme::url('data') }}/icon-s4.png" alt="service">
                                </div>
                ...
                <li class="col-xs-12 col-sm-6 col-md-4 services2-item">
                    <div class="service-wapper">
                        <div class="row">
                            <div class="col-sm-6 image">
                                <div class="icon">
                                    <img src="{{ Theme::url('data') }}/icon-s5.png" alt="service">
                                </div>
                ...
                <li class="col-xs-12 col-sm-6 col-md-4 services2-item">
                    <div class="service-wapper">
                        <div class="row">
                            <div class="col-sm-6 image">
                                <div class="icon">
                                    <img src="{{ Theme::url('data') }}/icon-s6.png" alt="service">
                                </div>
...
<div id="introduce-box" class="row">
    <div class="col-md-3">
        <div id="address-box">
            <a href="#"><img src="{{ Theme::url('data') }}/option6/logo-footer.png" alt="logo" /></a>
            <div id="address-list">
...
<div id="trademark-box" class="row">
    <div class="col-sm-12">
        <ul id="trademark-list">
            ...
            <li>
                <a href="#"><img src="{{ Theme::url('data') }}/trademark-ups.jpg"  alt="ups"/></a>
            </li>
            <li>
                <a href="#"><img src="{{ Theme::url('data') }}/trademark-qiwi.jpg"  alt="ups"/></a>
            </li>
            <li>
                <a href="#"><img src="{{ Theme::url('data') }}/trademark-wu.jpg"  alt="ups"/></a>
            </li>
            <li>
                <a href="#"><img src="{{ Theme::url('data') }}/trademark-cn.jpg"  alt="ups"/></a>
            </li>
            <li>
                <a href="#"><img src="{{ Theme::url('data') }}/trademark-visa.jpg"  alt="ups"/></a>
            </li>
            <li>
                <a href="#"><img src="{{ Theme::url('data') }}/trademark-mc.jpg"  alt="ups"/></a>
            </li>
            <li>
                <a href="#"><img src="{{ Theme::url('data') }}/trademark-ems.jpg"  alt="ups"/></a>
            </li>
            <li>
                <a href="#"><img src="{{ Theme::url('data') }}/trademark-dhl.jpg"  alt="ups"/></a>
            </li>
            <li>
                <a href="#"><img src="{{ Theme::url('data') }}/trademark-fe.jpg"  alt="ups"/></a>
            </li>
            <li>
                <a href="#"><img src="{{ Theme::url('data') }}/trademark-wm.jpg"  alt="ups"/></a>
            </li>
        </ul>
    </div>
</div> <!-- /#trademark-box -->
...
<!-- Script-->
<script type="text/javascript" src="{{ Theme::url('vendor/jquery/jquery-1.11.2.min.js') }}"></script>
<script type="text/javascript" src="{{ Theme::url('vendor/bootstrap/js/bootstrap.min.js') }}"></script>
<script type="text/javascript" src="{{ Theme::url('vendor/select2/js/select2.min.js') }}"></script>
<script type="text/javascript" src="{{ Theme::url('vendor/jquery.bxslider/jquery.bxslider.min.js') }}"></script>
<script type="text/javascript" src="{{ Theme::url('vendor/owl.carousel/owl.carousel.min.js') }}"></script>
<!--<script type="text/javascript" src="assets/lib/jquery.countdown/jquery.countdown.min.js"></script>-->
<!-- COUNTDOWN -->
<script type="text/javascript" src="{{ Theme::url('vendor/countdown/jquery.plugin.js') }}"></script>
<script type="text/javascript" src="{{ Theme::url('vendor/countdown/jquery.countdown.js') }}"></script>
<!-- ./COUNTDOWN -->
<script type="text/javascript" src="{{ Theme::url('js/jquery.actual.min.js') }}"></script>
<script type="text/javascript" src="{{ Theme::url('js/theme-script.js') }}"></script>
