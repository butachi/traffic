...
use Modules\Core\Auth\Cookies\CookieInterface;
use Modules\Core\Auth\Sessions\SessionInterface;
...
class IlluminatePersistenceRepository implements PersistenceRepositoryInterface
{
     ...
     *
     * @var \Modules\Core\Auth\Sessions\SessionInterface
     */
    protected $session;
     ...
     *
     * @var \Modules\Core\Auth\Cookies\CookieInterface
     */
    protected $cookie;
     ...
     * @var string
     */
    protected $model = 'Modules\Core\Auth\Persistences\EloquentPersistence';
