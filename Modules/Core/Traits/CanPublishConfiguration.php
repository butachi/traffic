...
trait CanPublishConfiguration
{
    ...
    public function publishConfig($module, $fileName)
    {
        ...
        $this->mergeConfigFrom($this->getModuleConfigFilePath($module, $fileName), strtolower("beputi.$module.$fileName"));
        $this->publishes([
            $this->getModuleConfigFilePath($module, $fileName) => config_path(strtolower("beputi/$module/$fileName") . '.php'),
        ], 'config');
    }
