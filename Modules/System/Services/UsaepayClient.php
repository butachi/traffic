<?php namespace Modules\System\Services;
...
class UsaepayClient {
    ...
    {
        return $this->config['protocol'] . '://' . $this->domain() . $this->config['wsdl'];
    }
    /**
     * Returns the url
     *
    ...
    public function url()
    {
        return $this->config['protocol'] . '://' . $this->domain();
    }
    /**
     * Returns the domain
     *
